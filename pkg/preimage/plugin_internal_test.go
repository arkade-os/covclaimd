...
type fixture struct {
	t             *testing.T
	covclaimdPriv *btcec.PrivateKey
...
func newFixture(t *testing.T) *fixture {
	t.Helper()
	covclaimdPriv, err := btcec.NewPrivateKey()
...
func TestPluginDecode_Match(t *testing.T) {
	...
	matched, ok := f.plugin.decode(tx, ext)
	require.True(t, ok)
